...
################################################################
# This is a generated script based on design: tdc_system
#
...
# source tdc_system_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# led_blinker, axilite_slave
...
\
  ...
  set block_name axilite_slave
  set block_cell_name axilite_slave_0
  if { [catch {set axilite_slave_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axilite_slave_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins axilite_slave_0/S_AXI]
  ...
  connect_bd_net -net axilite_slave_0_S_AXI_REG0_OUT  [get_bd_pins axilite_slave_0/S_AXI_REG0_OUT] \
  [get_bd_pins led_blinker_0/reg_i]
  connect_bd_net -net led_blinker_0_led_o  [get_bd_pins led_blinker_0/led_o] \
  [get_bd_ports LED_O]
  ...
  [get_bd_pins led_blinker_0/clk_i] \
  [get_bd_pins axilite_slave_0/S_AXI_ACLK] \
  ...
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axilite_slave_0/S_AXI/reg0] -force
